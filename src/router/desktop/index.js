...
const router = createRouter({
  ...
  routes: [
    ...
    {
      path: '/admin/:tab?/:secTab?',
      name: 'admin-panel',
      // route level code-splitting
      // this generates a separate chunk (About.[hash].js) for this route
      // which is lazy-loaded when the route is visited.
      component: () => import('../../views/desktop/admin/AdminView.vue')
    },
    {
      path: '/article/:id',
      name: 'article',
      ...
      // this generates a separate chunk (About.[hash].js) for this route
      // which is lazy-loaded when the route is visited.
      component: () => import('../../views/desktop/user/ArticleView.vue')
    },
    {
      path: '/articles',
      name: 'all-articles',
      ...
      // this generates a separate chunk (About.[hash].js) for this route
      // which is lazy-loaded when the route is visited.
      component: () => import('../../views/desktop/user/AllArticlesView.vue')
    }
  ]
})
